...
menuIcon.addEventListener('click', function () {
  ...
  if (this.classList.contains('active')) {
    menuIconFont.setAttribute('class', 'ri-close-circle-line');
    mobileMenus.style.height = mobileMenus.scrollHeight + 'px';
  } else {
    menuIconFont.setAttribute('class', 'ri-menu-4-line');
...
// 나 menuScroll.addEventListener('down', function(){
//   this.classList.scrollHeight('active');
...
setTimeout(() => {
  const swiper = new Swiper('.swiper', {
    // Optional parameters
    // direction: 'vertical', // 앞에 주석되면 default: horizontal
